    ...
    <main className="grid min-h-screen place-items-center bg-neutral-50 px-6 py-10">
      <section className="flex w-full max-w-sm flex-col gap-6 rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-neutral-950">Konto erstellen</h1>
          <p className="text-sm leading-6 text-neutral-600">
            Dieses Konto gehört nur zur neuen Luma. Deine alte Anmeldung bleibt unverändert.
          </p>
        </div>
        <NewRegisterForm />
        <p className="text-center text-sm text-neutral-600">
          Schon registriert?{" "}
          <Link href="/neu/anmelden" className="font-medium text-neutral-950 underline underline-offset-4">Anmelden</Link>
        </p>
